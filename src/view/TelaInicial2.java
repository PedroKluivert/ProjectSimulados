...
public class TelaInicial2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel_FUNDO.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/TelaIncial.png"))); // NOI18N
        getContentPane().add(jLabel_FUNDO, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 510, 313));

        getAccessibleContext().setAccessibleDescription("");

        setSize(new java.awt.Dimension(510, 330));
    ...
    private void formKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_formKeyPressed
        TelaInicial2 telinha = new TelaInicial2();
